----
-- DeltaX — alert log table (alex.public) — bootstrap for fresh install
--
-- Creates the full current schema. For existing databases use migrations instead:
...
CREATE TABLE deltax_alerts (
    ...
    implied_drop_pct            NUMERIC(8, 4) NOT NULL,
    tier_window_seconds         INTEGER NOT NULL,
    tier_drop_pct               NUMERIC(8, 4) NOT NULL,
    tier_implied_drop_pct       NUMERIC(8, 4) NOT NULL,
